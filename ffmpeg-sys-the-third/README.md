...
A word on versioning: The crate version includes the **maximum supported** FFmpeg version for each release. E.g. `ffmpeg-sys-the-third@4.0.0+ffmpeg-8.0` supports *up to* FFmpeg 8.0. The minimum supported FFmpeg version at the moment is 7.0.
